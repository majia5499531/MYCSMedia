//
//  SZArticlePreviewVC.m
//  MYCSMedia
//
//  Created by 马佳 on 2022/4/19.
//

#import "SZArticlePreviewVC.h"
#import "SZDefines.h"
...
@interface SZArticlePreviewVC ()

@end

@implementation SZArticlePreviewVC
...
-(void)initSubviews
{
    ...
    //cancel
    MJButton * previewBtn = [[MJButton alloc]initWithFrame:CGRectMake(16, STATUS_BAR_HEIGHT+8, 55, 26)];
    previewBtn.mj_text=@"预览";
    previewBtn.mj_font=BOLD_FONT(15);
    previewBtn.mj_textColor=HW_BLACK;
